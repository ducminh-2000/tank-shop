...
declare type RoleResolverCallback = (err: Error | null, inRole?: boolean) => any
...
declare class PersistedModelStatic<T> {
  ...
  replicate: (since?: number, targetModel?: PersistedModel<T>, options?: any, optionsFilter?: any, callback?: (err: Error, conflicts: Conflict[], param: any) => void) => (Promise<{ conflicts: Conflict[]; params: any }> | void);
